...
const TestimonialsSection = () => {
  return <section id="testimonials" className="py-16 md:py-0">
          ...
          animationDelay: `${index * 0.1}s`
              ...
              <CardContent className="p-6">
                ...
                <div className="flex mb-3">
                  {Array(testimonial.stars).fill(0).map((_, i) => <Star key={i} className="h-4 w-4 fill-habit-yellow text-habit-yellow" />)}
                </div>
